document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderLivros() {
        container.innerHTML = '<h2 class="mb-4">Livros do Antigo Testamento</h2>';
        const livros = biblia.slice(0, 39); // Antigo Testamento
    ...
    fetch(apiUrl)
        ...
        .catch(() => {
            container.innerHTML = '<div class="alert alert-danger">Erro ao carregar os livros do Antigo Testamento.</div>';
        });
}); 